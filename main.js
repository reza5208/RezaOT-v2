...
(function () {
  ...
  function boot() {
    ...
    loadScript("main-app-1.js?v=32")
      .then(function () { return loadScript("main-app-2.js?v=32"); })
      .then(function () {
        return Promise.all([
          loadScript("salary-estimator.js?v=32"),
          loadScript("app-p1.js?v=32"),
          loadScript("sync-fix.js?v=32")
        ]);
      })
      .then(function () {
