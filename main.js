...
(function () {
  ...
  function boot() {
    ...
    loadScript("main-app-1.js?v=57")
      .then(function () { return loadScript("main-app-2.js?v=57"); })
      .then(function () {
        return Promise.all([
          loadScript("salary-estimator.js?v=57"),
          loadScript("app-p1.js?v=57")
        ]);
      })
      .then(function () { return loadScript("app-p1-extra.js?v=57"); })
      .then(function () {
